...
function getWeatherData(lat, lon) {
  let apiKey = "83ftcfac2eb5764705dbe83a0o34296c";
...
function getHourlyData(lat, lon) {
  let api_key = "83ftcfac2eb5764705dbe83a0o34296c";
  let api_url = `https://api.shecodes.io/weather/v1/forecast?lon=${lon}&lat=${lat}&key=${api_key}`;
  console.log(api_url);
